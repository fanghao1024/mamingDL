...
class Variable:
    ...
    def __repr__(self):
        ...
        txt=str(self.data).replace('\n','\n'+' '*9)
        return 'Variable('+txt+')'

    def sum(self,axis=None,keepdims=False):
        return mamingDL.functions.sum(self,axis,keepdims)

    def reshape(self,*shape):
        if len(shape)==1 and isinstance(shape[0],(list,tuple)):
            shape=shape[0]
        return mamingDL.functions.reshape(self,shape)
    ...
    def transpose(self,*axes):
        if len(axes)==0:
            ...
            if isinstance(axes[0],(tuple,list)) or axes[0] is None:
                axes=axes[0]
        return mamingDL.functions.transpose(self,axes)
...
class Add(Function):
    ...
    def backward(self,gy):
        ...
        if self.x0_shape!=self.x1_shape:
            gx0=mamingDL.functions.sum_to(gx0,self.x0_shape)
            gx1=mamingDL.functions.sum_to(gx1,self.x1_shape)
        return gx0,gx1
...
class Div(Function):
    ...
    def backward(self,gy):
        ...
        if x0.shape!=x1.shape:
            gx0=mamingDL.functions.sum_to(gx0,x0.shape)
            gx1=mamingDL.functions.sum_to(gx1,x1.shape)
        return gx0,gx1
