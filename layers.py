...
from mamingDL.utils import pair
import os
...
class LSTM(Layer):
    def __init__(self,hidden_size,in_size=None):
        ...
        self.h2f=Linear(H,in_size=H,no_bias=True)
        self.h2i=Linear(H,in_size=H,no_bias=True)
        self.h2o=Linear(H,in_size=H,no_bias=True)
        self.h2u=Linear(H,in_size=H,no_bias=True)
        self.reset_state()
    def reset_state(self):
        self.h=None
        self.c=None
